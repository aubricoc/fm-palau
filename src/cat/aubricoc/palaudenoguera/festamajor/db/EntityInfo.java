...
import cat.aubricoc.palaudenoguera.festamajor.db.enums.Column;
import cat.aubricoc.palaudenoguera.festamajor.db.enums.Entity;
import cat.aubricoc.palaudenoguera.festamajor.db.enums.GeneratedValue;
import cat.aubricoc.palaudenoguera.festamajor.db.enums.Id;
import cat.aubricoc.palaudenoguera.festamajor.db.enums.OrderBy;
import cat.aubricoc.palaudenoguera.festamajor.db.enums.Table;
							...
							if (pk != null) {
								throw new IllegalStateException(
										"Class "
												...
												+ " have more than one @Column(id=true)");
							}
							pk = fieldInfo;
						}
